# Configuración de Red: Enrutamiento Estático por Defecto
...
* RT‑01 tiene el clock rate por ser DCE.
* RT‑02 sincroniza como DTE.
* Las rutas por defecto permiten la comunicación entre redes.
* Las SVI son solo para administración.

---

**Fin**

![Referencia a imagen de los comandos](img/defecto.png)
